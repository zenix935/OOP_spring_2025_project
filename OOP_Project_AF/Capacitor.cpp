...
string Capacitor::toString() const { return "Capacitor "+name+" "+node1+" "+node2+" "+to_string(value)+"F"; }
...
void Capacitor::updateTransientState(const vector<double>& current_voltages,const vector<double>& current_branch_currents,
