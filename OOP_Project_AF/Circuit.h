...
public:
	...
	void updateNodesAndVoltageSourceIndices(); // Helper to update nodes and independent voltage source current indices
	...
	void addSource(const string& type,const string& name,const string& node1,const string& node2,const string& val1,const string& val2="");
